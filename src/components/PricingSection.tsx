...
const content = {
  en: {
    ...
    bundle: { label: "10-Class Bundle", price: "$180", duration: "$18 USD per hour (save $20 USD)", desc: "Commit to your progress with a discounted package of ten one-on-one lessons.", features: ["10 private lessons", "Best value per hour", "Priority scheduling"], badge: "Best Value" },
    cta: "Book Now",
  },
  zh: {
    title: "简单透明的价格",
