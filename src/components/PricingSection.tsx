...
const content = {
  en: {
    ...
    regular: { label: "One-on-One Lessons", price: "$25", duration: "per hour", desc: "Private, conversation-focused lessons tailored to your level and interests.", features: ["Flexible scheduling", "Personalized curriculum", "Homework & resources"] },
  ...
  zh: {
    ...
    regular: { label: "一对一课程", price: "$25", duration: "每小时", desc: "针对您的水平和兴趣量身定制的对话式私人课程。", features: ["灵活安排时间", "个性化课程", "作业和资源"] },
